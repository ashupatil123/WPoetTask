    ...
    <div class="col-md-3 col-sm-6 my-3 my-md-0">
        <form action="add.php" method="post">
          <div class="card shadow">
            <div>
              <img src="img/sc1.jpg" alt="Image" class="img-fluid Cart-img-top">
            </div>
            <div class="card-body">
              <h5 class="card-title">SKIN E OIL</h5>
              <h6>
              ...
              <h5>
                <small><s class="text-secondary">$1400</s></small>
                <span class="price">$1200</span>
              </h5>
              <button type="submit"  href="add.php" class="btn btn-warning my-3" name="add">Add To Cart <i class="fas fa-shopping-cart"></i></button>
            </div>
          </div>
        </form>
      </div>
      ...
      <div class="col-md-3 col-sm-6 my-3 my-md-0">
        <form action="add.php" method="post">
          <div class="card shadow">
            <div>
              <img src="img/sc2.jpg" alt="Image" class="img-fluid Cart-img-top">
            </div>
            <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 my-3 my-md-0">
        <form action="add.php" method="post">
          <div class="card shadow">
            <div>
              <img src="img/sc3.jpg" alt="Image" class="img-fluid Cart-img-top">
            </div>
            <div class="card-body">
              <h5 class="card-title">SUN SCREEM</h5>
              <h6>
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
      ...
      <div class="col-md-3 col-sm-6 my-3 my-md-0">
        <form action="add.php" method="post">
          <div class="card shadow">
            <div>
              <img src="img/sc4.jpg" alt="Image" class="img-fluid Cart-img-top">
            </div>
            <div class="card-body">
              ...
              <p class="card-text">Type of Service(Handset).Repair service carried at Samsung authorized service center Additional Information. </p>
              <h5>
                <small><s class="text-secondary">$800</s></small>
                <span class="price">$700</span>
              </h5>
              <button type="submit"  href="dbcon.php" class="btn btn-warning my-3" name="add">Add To Cart <i class="fas fa-shopping-cart"></i></button>
            </div>
