    ...
    <div class="col-md-3 col-sm-6 my-3 my-md-0">
        <form action="add.php" method="post">
          <div class="card shadow">
            <div>
              <img src="img/j1.jpg" alt="Image" class="img-fluid Cart-img-top">
            </div>
            <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 my-3 my-md-0">
        <form action="add.php" method="post">
          <div class="card shadow">
            <div>
              <img src="img/j2.jpg" alt="Image" class="img-fluid Cart-img-top">
            </div>
            <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 my-3 my-md-0">
        <form action="add.php" method="post">
          <div class="card shadow">
            <div>
              <img src="img/j3.jpg" alt="Image" class="img-fluid Cart-img-top">
            </div>
            <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6 my-3 my-md-0">
        <form action="add.php" method="post">
          <div class="card shadow">
            <div>
              <img src="img/j4.jpg" alt="Image" class="img-fluid Cart-img-top">
            </div>
            <div class="card-body">
